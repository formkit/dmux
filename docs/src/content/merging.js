...
export function render() {
  return `
    ...
    <ol>
      ...
      <li>Generates a commit message using AI (via your configured provider)</li>
    ...
    <div class="callout callout-info">
      ...
      If no AI provider is available, dmux will use a generic commit message like "dmux: auto-commit changes".
    </div>
