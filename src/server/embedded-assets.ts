...
* (c) 2018-present Yuxi (Evan) You and Vue contributors
* @license MIT
**/function Zc(){wc()}Zc();const af=(e,t)=>{const n=e.__vccOpts||e;for(const[s,r]of t)n[s]=r;return n};export{Pe as F,af as _,ll as a,Eo as b,rf as c,nf as d,of as e,ic as f,sf as g,tf as h,ff as i,ec as j,ms as k,uf as l,vc as m,gs as n,rl as o,Di as p,ef as r,Qo as t,lf as v,cf as w};
`,
    mimeType: 'application/javascript',
    size: 91159
  },
...
<head>
  ...
  <link rel="modulepreload" crossorigin href="/chunks/_plugin-vue_export-helper-ChVKtMxh.js">
...
`,
  ...
  'dashboard.js': {
<<<<<<< HEAD
    content: `import{d as ue,r as c,o as ve,a as ge,_ as me,c as s,b as o,t as r,e as d,n as he,f as pe,F as p,g as D,w as M,h as Z,v as G,i as X,j as i,k as N,l as fe}from"./chunks/_plugin-vue_export-helper-ChVKtMxh.js";const ye=ue({__name:"Dashboard",setup(Y,{expose:a}){a();const F=c("Loading..."),e=c(""),T=c(!1),O=c([]),t=c(null),v=c("Never"),P=c({}),m=c(new Set),I=c({}),w=c(localStorage.getItem("dmux-theme")||"dark"),b=c(new Set),h=c(new Set),E=c(!1),x=c(""),y=c(null),U=c(!1),j=c([]),z=c(!1),C=c("prompt"),$=c([]),V=c({}),k=c(null),_=c(null),B=c(!1);let S=null;const ee=()=>{w.value=w.value==="dark"?"light":"dark",localStorage.setItem("dmux-theme",w.value),document.documentElement.setAttribute("data-theme",w.value)},te=n=>{b.value.has(n)?b.value.delete(n):b.value.add(n),b.value=new Set(b.value)},oe=()=>{E.value=!0,x.value="",y.value=null,j.value=[],z.value=!1,C.value="prompt"},R=()=>{E.value=!1,x.value="",y.value=null,j.value=[],z.value=!1,C.value="prompt"},K=async()=>{if(!(C.value==="prompt"&&!x.value.trim())&&!(C.value==="agent"&&!y.value))try{U.value=!0;const n={prompt:x.value.trim()};y.value&&(n.agent=y.value);const u=await(await fetch("/api/panes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json();u.needsAgentChoice?(z.value=!0,j.value=u.availableAgents,C.value="agent"):(R(),await f())}catch(n){console.error("Failed to create pane:",n),alert("Failed to create pane")}finally{U.value=!1}},ne=n=>{y.value=n,K()},f=async()=>{try{const l=await(await fetch("/api/panes")).json();F.value=l.projectName||"dmux",e.value=l.sessionName||"",T.value=!0,O.value=l.panes||[],t.value=new Date,v.value="Just now";for(const u of O.value)V.value[u.id]||Q(u.id)}catch(n){console.error("Failed to fetch panes:",n),T.value=!1}},Q=async n=>{try{const u=await(await fetch(\`/api/panes/\${n}/actions\`)).json();console.log(\`Fetched actions for pane \${n}:\`,u),V.value[n]=u.actions||[]}catch(l){console.error(\`Failed to fetch actions for pane \${n}:\`,l)}},ae=n=>{k.value===n?k.value=null:k.value=n},se=async(n,l)=>{try{B.value=!0,k.value=null;const g=await(await fetch(\`/api/panes/\${n.id}/actions/\${l.id}\`,{method:"POST"})).json();if(g.requiresInteraction){let A={};g.interactionType==="confirm"?A={type:"confirm",title:g.title||"Confirm",message:g.message,...g.confirmData}:g.interactionType==="choice"?A={type:"choice",title:g.title||"Choose",message:g.message,...g.choiceData}:g.interactionType==="input"&&(A={type:"input",title:g.title||"Input",message:g.message,...g.inputData}),A.paneId=n.id,_.value=A}else await f()}catch(u){console.error("Failed to execute action:",u),alert("Failed to execute action")}finally{B.value=!1}},H=()=>{_.value=null},ie=async n=>{if(_.value)try{const l=await fetch(\`/api/callbacks/confirm/\${_.value.callbackId}\`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({confirmed:n})});await f(),H()}catch(l){console.error("Failed to confirm action:",l),alert("Failed to complete action")}},le=async n=>{if(_.value)try{const l=await fetch(\`/api/callbacks/choice/\${_.value.callbackId}\`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({optionId:n})});await f(),H()}catch(l){console.error("Failed to select choice:",l),alert("Failed to complete action")}},ce=async(n,l)=>{try{h.value.add(n.id),h.value=new Set(h.value);const u=l.keys||[l.action];for(const g of u)await fetch(\`/api/keys/\${n.id}\`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:g})});setTimeout(()=>{h.value.delete(n.id),h.value=new Set(h.value),f()},1500)}catch(u){console.error("Failed to select option:",u),h.value.delete(n.id),h.value=new Set(h.value)}},re=async n=>{const l=P.value[n.id];if(!(!l||!l.trim()))try{m.value.add(n.id),m.value=new Set(m.value);for(const u of l)await fetch(\`/api/keys/\${n.id}\`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:u})});await fetch(\`/api/keys/\${n.id}\`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({key:"Enter"})}),I.value[n.id]=l.substring(0,50)+(l.length>50?"...":""),P.value[n.id]="",setTimeout(()=>{delete I.value[n.id],m.value.delete(n.id),m.value=new Set(m.value)},3e3)}catch(u){console.error("Failed to send prompt:",u),m.value.delete(n.id),m.value=new Set(m.value)}},de=n=>{const l=n.target;l.style.height="auto",l.style.height=l.scrollHeight+"px"},J=()=>{f(),S=setInterval(f,2e3)},L=()=>{S&&(clearInterval(S),S=null)},q=n=>{const l=n.target;k.value&&!l.closest(".action-menu-btn")&&!l.closest(".action-menu-dropdown")&&(k.value=null)};ve(()=>{document.documentElement.setAttribute("data-theme",w.value),J(),document.addEventListener("click",q),document.addEventListener("visibilitychange",()=>{document.hidden?L():J()})}),ge(()=>{L(),document.removeEventListener("click",q)});const W={projectName:F,sessionName:e,connected:T,panes:O,lastUpdate:t,timeSinceUpdate:v,promptInputs:P,sendingPrompts:m,queuedMessages:I,theme:w,expandedPrompts:b,loadingOptions:h,showCreateDialog:E,newPanePrompt:x,newPaneAgent:y,creatingPane:U,availableAgents:j,needsAgentChoice:z,createStep:C,actions:$,paneActions:V,showActionMenu:k,actionDialog:_,executingAction:B,get refreshInterval(){return S},set refreshInterval(n){S=n},toggleTheme:ee,togglePrompt:te,openCreateDialog:oe,closeCreateDialog:R,createPane:K,selectAgent:ne,fetchPanes:f,fetchPaneActions:Q,toggleActionMenu:ae,executeAction:se,closeActionDialog:H,confirmAction:ie,selectChoice:le,selectOption:ce,sendPrompt:re,autoExpand:de,startAutoRefresh:J,stopAutoRefresh:L,handleClickOutside:q};return Object.defineProperty(W,"__isScriptSetup",{enumerable:!1,value:!0}),W}}),ke={class:"session-info"},_e=["title"],we={key:0,xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},be={key:1,xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},Ce={key:0},Se={class:"container"},Pe={class:"actions-bar"},xe=["disabled"],Ae={key:0,class:"no-panes"},De={key:1,class:"panes-grid"},Me={class:"pane-header"},Ne={class:"pane-header-content"},Te=["href"],Oe={class:"pane-title"},je={class:"pane-meta"},ze={class:"pane-id"},Fe=["onClick"],Ie={key:0,class:"action-menu-dropdown"},Ee=["onClick","disabled"],Ue={class:"action-icon"},Ve={class:"action-label"},Be={class:"pane-prompt-section"},He=["onClick"],Je={class:"expand-icon"},Le={key:0,class:"pane-prompt"},qe={key:1,class:"agent-summary"},Re={key:0,class:"options-dialog"},Ke={class:"options-question"},Qe={key:0,class:"options-warning"},We={key:1,class:"analyzing-state"},Ze={key:2,class:"options-buttons"},Ge=["onClick","disabled"],Xe={class:"prompt-input-wrapper"},Ye=["onUpdate:modelValue","placeholder","disabled"],$e=["onClick","disabled","title"],et={key:0,class:"button-loader"},tt={key:1,xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 988.44 1200.05"},ot={key:0,class:"queued-message"},nt={key:2,class:"dev-server-status"},at=["href"],st={class:"action-dialog"},it={key:0},lt=["onKeydown"],ct={class:"dialog-buttons"},rt=["disabled"],dt={key:1},ut={class:"agent-choices"},vt=["onClick","disabled"],gt={key:0,class:"action-dialog"},mt={class:"dialog-buttons"},ht={class:"action-dialog"},pt={key:0},ft={class:"choice-options"},yt=["onClick"],kt={class:"choice-label"},_t={key:0,class:"choice-description"};function wt(Y,a,F,e,T,O){return i(),s(p,null,[o("header",null,[a[6]||(a[6]=o("img",{src:"https://cdn.formk.it/dmux/dmux.png",alt:"dmux",class:"logo"},null,-1)),o("h1",null,r(e.projectName),1),o("div",ke,[o("button",{onClick:e.toggleTheme,class:"theme-toggle",title:e.theme==="dark"?"Switch to light mode":"Switch to dark mode"},[e.theme==="dark"?(i(),s("svg",we,[...a[4]||(a[4]=[o("path",{d:"M12 2.25a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zM7.5 12a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM18.894 6.166a.75.75 0 00-1.06-1.06l-1.591 1.59a.75.75 0 101.06 1.061l1.591-1.59zM21.75 12a.75.75 0 01-.75.75h-2.25a.75.75 0 010-1.5H21a.75.75 0 01.75.75zM17.834 18.894a.75.75 0 001.06-1.06l-1.59-1.591a.75.75 0 10-1.061 1.06l1.59 1.591zM12 18a.75.75 0 01.75.75V21a.75.75 0 01-1.5 0v-2.25A.75.75 0 0112 18zM7.758 17.303a.75.75 0 00-1.061-1.06l-1.591 1.59a.75.75 0 001.06 1.061l1.591-1.59zM6 12a.75.75 0 01-.75.75H3a.75.75 0 010-1.5h2.25A.75.75 0 016 12zM6.697 7.757a.75.75 0 001.06-1.06l-1.59-1.591a.75.75 0 00-1.061 1.06l1.59 1.591z"},null,-1)])])):(i(),s("svg",be,[...a[5]||(a[5]=[o("path",{d:"M9.528 1.718a.75.75 0 01.162.819A8.97 8.97 0 009 6.5a9 9 0 009 9 8.97 8.97 0 003.963-.69.75.75 0 01.981.98 10.503 10.503 0 01-9.694 6.46c-5.799 0-10.5-4.701-10.5-10.5 0-4.368 2.667-8.112 6.46-9.694a.75.75 0 01.818.162z"},null,-1)])]))],8,_e),e.sessionName?(i(),s("span",Ce,r(e.sessionName),1)):d("v-if",!0),o("span",{class:"status-indicator",style:he({color:e.connected?"#4ade80":"#f87171"})},"●",4)])]),o("div",Se,[o("main",null,[o("div",Pe,[o("button",{onClick:e.openCreateDialog,class:"create-pane-button",disabled:e.creatingPane},[...a[7]||(a[7]=[o("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor"},[o("path",{d:"M12 4.5v15m7.5-7.5h-15",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"})],-1),pe(" Create New Pane ",-1)])],8,xe)]),e.panes.length===0?(i(),s("div",Ae,[...a[8]||(a[8]=[o("p",null,"No dmux panes active",-1),o("p",{class:"hint"},\`Click "Create New Pane" above or press 'n' in dmux\`,-1)])])):(i(),s("div",De,[(i(!0),s(p,null,D(e.panes,t=>(i(),s("div",{key:t.id,class:"pane-card"},[o("div",Me,[o("div",Ne,[o("a",{href:"/panes/"+t.id,class:"pane-title-link"},[o("span",Oe,r(t.slug),1),a[9]||(a[9]=o("span",{class:"pane-arrow"},"→",-1))],8,Te),o("div",je,[o("span",{class:N(["pane-agent",t.agent||""])},r(t.agent||"unknown"),3),o("span",ze,r(t.paneId),1)])]),o("button",{onClick:v=>e.toggleActionMenu(t.id),class:"action-menu-btn",title:"Actions"},[...a[10]||(a[10]=[o("span",null,"⋮",-1)])],8,Fe)]),d(" Action Menu Dropdown "),e.showActionMenu===t.id&&e.paneActions[t.id]?(i(),s("div",Ie,[(i(!0),s(p,null,D(e.paneActions[t.id],v=>(i(),s("button",{key:v.id,onClick:P=>e.executeAction(t,v),class:"action-menu-item",disabled:e.executingAction},[o("span",Ue,r(v.icon||"•"),1),o("span",Ve,r(v.label),1)],8,Ee))),128))])):d("v-if",!0),o("div",Be,[o("div",{class:N(["pane-prompt-header",{expanded:e.expandedPrompts.has(t.id)}]),onClick:v=>e.togglePrompt(t.id)},[a[11]||(a[11]=o("span",{class:"prompt-label"},"Initial Prompt",-1)),o("span",Je,r(e.expandedPrompts.has(t.id)?"▼":"▶"),1)],10,He),e.expandedPrompts.has(t.id)?(i(),s("div",Le,r(t.prompt||"No prompt"),1)):d("v-if",!0)]),d(" Show agent summary when idle "),t.agentStatus==="idle"&&t.agentSummary?(i(),s("div",qe,r(t.agentSummary),1)):d("v-if",!0),o("div",{class:"pane-interactive",onClick:a[0]||(a[0]=M(()=>{},["prevent"]))},[d(" Options Dialog (when waiting with options) "),t.agentStatus==="waiting"&&t.options&&t.options.length>0?(i(),s("div",Re,[o("div",Ke,r(t.optionsQuestion||"Choose an option:"),1),t.potentialHarm&&t.potentialHarm.hasRisk?(i(),s("div",Qe," ⚠️ "+r(t.potentialHarm.description),1)):d("v-if",!0),e.loadingOptions.has(t.id)?(i(),s("div",We,[...a[12]||(a[12]=[o("div",{class:"loader-spinner"},null,-1),o("span",null,"Processing selection...",-1)])])):(i(),s("div",Ze,[(i(!0),s(p,null,D(t.options,v=>(i(),s("button",{key:v.action,onClick:P=>e.selectOption(t,v),class:N(["option-button",{"option-button-danger":t.potentialHarm&&t.potentialHarm.hasRisk}]),disabled:e.loadingOptions.has(t.id)},r(v.action),11,Ge))),128))]))])):t.agentStatus==="analyzing"?(i(),s(p,{key:1},[d(" Analyzing (show loader) "),a[13]||(a[13]=o("div",{class:"analyzing-state"},[o("div",{class:"loader-spinner"}),o("span",null,"Analyzing...")],-1))],2112)):(i(),s(p,{key:2},[d(" Working/Idle (show prompt input) "),o("div",null,[o("div",Xe,[Z(o("textarea",{"onUpdate:modelValue":v=>e.promptInputs[t.id]=v,onInput:e.autoExpand,placeholder:t.agentStatus==="working"?"Queue a prompt...":"Send a prompt...",disabled:e.sendingPrompts.has(t.id),class:"prompt-textarea",rows:"1"},null,40,Ye),[[G,e.promptInputs[t.id]]]),o("button",{onClick:v=>e.sendPrompt(t),disabled:!e.promptInputs[t.id]||e.sendingPrompts.has(t.id),class:"send-button",title:t.agentStatus==="working"?"Queue prompt":"Send prompt"},[e.sendingPrompts.has(t.id)?(i(),s("span",et)):(i(),s("svg",tt,[...a[14]||(a[14]=[o("path",{d:"M425.13,28.37L30.09,423.41C11.19,441.37.34,466.2,0,492.27c-.34,26.07,9.86,51.17,28.29,69.61,18.43,18.45,43.52,28.67,69.59,28.35,26.07-.31,50.91-11.14,68.88-30.02l233.16-233.52v776.64c0,34.56,18.43,66.48,48.36,83.76,29.93,17.28,66.8,17.28,96.72,0,29.93-17.28,48.36-49.21,48.36-83.76V328.85l231.72,231.36c24.63,23.41,59.74,32.18,92.48,23.09,32.74-9.08,58.32-34.68,67.38-67.43,9.05-32.75.25-67.85-23.18-92.46L566.73,28.37C548.63,10.16,524-.04,498.33.05c-.8-.06-1.6-.06-2.4,0-.8-.06-1.6-.06-2.4,0-25.65,0-50.25,10.19-68.4,28.32h0Z"},null,-1)])]))],8,$e)]),e.queuedMessages[t.id]?(i(),s("div",ot," ✓ "+r(e.queuedMessages[t.id]),1)):d("v-if",!0)])],2112))]),t.devStatus&&t.devStatus!=="stopped"?(i(),s("div",nt,[a[15]||(a[15]=o("span",{class:"status-label"},"Dev Server:",-1)),o("span",{class:N(["status-badge",t.devStatus])},r(t.devStatus),3),t.devUrl?(i(),s("a",{key:0,href:t.devUrl,target:"_blank",class:"dev-link"},"↗",8,at)):d("v-if",!0)])):d("v-if",!0)]))),128))]))]),d(" Create Pane Dialog "),e.showCreateDialog?(i(),s("div",{key:0,class:"action-dialog-overlay",onClick:M(e.closeCreateDialog,["self"])},[o("div",st,[a[18]||(a[18]=o("h3",null,"Create New Pane",-1)),e.createStep==="prompt"?(i(),s("div",it,[a[16]||(a[16]=o("label",{for:"pane-prompt"},"What would you like to work on?",-1)),Z(o("textarea",{id:"pane-prompt","onUpdate:modelValue":a[1]||(a[1]=t=>e.newPanePrompt=t),placeholder:"E.g., Fix the authentication bug, Add dark mode, etc.",rows:"4",onKeydown:[X(M(e.createPane,["meta"]),["enter"]),X(M(e.createPane,["ctrl"]),["enter"])]},null,40,lt),[[G,e.newPanePrompt]]),o("div",ct,[o("button",{onClick:e.closeCreateDialog,class:"dialog-btn"},"Cancel"),o("button",{onClick:e.createPane,disabled:!e.newPanePrompt.trim()||e.creatingPane,class:"dialog-btn dialog-btn-primary"},r(e.creatingPane?"Creating...":"Create Pane"),9,rt)])])):e.createStep==="agent"?(i(),s("div",dt,[a[17]||(a[17]=o("p",null,"Multiple agents available. Choose one:",-1)),o("div",ut,[(i(!0),s(p,null,D(e.availableAgents,t=>(i(),s("button",{key:t,onClick:v=>e.selectAgent(t),class:"agent-choice-button",disabled:e.creatingPane},r(t),9,vt))),128))]),o("div",{class:"dialog-buttons"},[o("button",{onClick:e.closeCreateDialog,class:"dialog-btn"},"Cancel")])])):d("v-if",!0)])])):d("v-if",!0),d(" Action Dialogs "),e.actionDialog?(i(),s("div",{key:1,class:"action-dialog-overlay",onClick:M(e.closeActionDialog,["self"])},[d(" Confirm Dialog "),e.actionDialog.type==="confirm"?(i(),s("div",gt,[o("h3",null,r(e.actionDialog.title),1),o("p",null,r(e.actionDialog.message),1),o("div",mt,[o("button",{onClick:a[2]||(a[2]=t=>e.confirmAction(!1)),class:"dialog-btn"},"Cancel"),o("button",{onClick:a[3]||(a[3]=t=>e.confirmAction(!0)),class:"dialog-btn dialog-btn-primary"},"Confirm")])])):e.actionDialog.type==="choice"?(i(),s(p,{key:1},[d(" Choice Dialog "),o("div",ht,[o("h3",null,r(e.actionDialog.title),1),e.actionDialog.message?(i(),s("p",pt,r(e.actionDialog.message),1)):d("v-if",!0),o("div",ft,[(i(!0),s(p,null,D(e.actionDialog.options,t=>(i(),s("button",{key:t.id,onClick:v=>e.selectChoice(t.id),class:N(["choice-option-btn",{danger:t.danger}])},[o("div",kt,r(t.label),1),t.description?(i(),s("div",_t,r(t.description),1)):d("v-if",!0)],10,yt))),128))]),o("div",{class:"dialog-buttons"},[o("button",{onClick:e.closeActionDialog,class:"dialog-btn"},"Cancel")])])],2112)):d("v-if",!0)])):d("v-if",!0)])],64)}const bt=me(ye,[["render",wt],["__file","/Users/justinschroeder/Projects/dmux/frontend/src/components/Dashboard.vue"]]),Ct=fe(bt);Ct.mount("#app");
`,
    mimeType: 'application/javascript',
    size: 15776
=======
    content: `import{d as de,r as c,o as ue,a as ve,_ as ge,c as s,b as o,t as r,e as d,n as me,f as he,F as h,g as x,w as A,h as W,v as Z,i as G,j as i,k as D,l as pe}from"./chunks/_plugin-vue_export-helper-ChVKtMxh.js";const fe=de({__name:"Dashboard",setup(X,{expose:a}){a();const z=c("Loading..."),e=c(""),M=c(!1),N=c([]),t=c(null),u=c("Never"),S=c({}),g=c(new Set),T=c({}),_=c(localStorage.getItem("dmux-theme")||"dark"),w=c(new Set),m=c(new Set),F=c(!1),P=c(""),y=c(null),I=c(!1),O=c([]),j=c(!1),b=c("prompt"),Y=c([]),E=c({}),k=c(null),p=c(null),U=c(!1);let C=null;const $=()=>{_.value=_.value==="dark"?"light":"dark",localStorage.setItem("dmux-theme",_.value),document.documentElement.setAttribute("data-theme",_.value)},ee=n=>{w.value.has(n)?w.value.delete(n):w.value.add(n),w.value=new Set(w.value)},te=()=>{F.value=!0,P.value="",y.value=null,O.value=[],j.value=!1,b.value="prompt"},q=()=>{F.value=!1,P.value="",y.value=null,O.value=[],j.value=!1,b.value="prompt"},J=async()=>{if(!(b.value==="prompt"&&!P.value.trim())&&!(b.value==="agent"&&!y.value))try{I.value=!0;const n={prompt:P.value.trim()};y.value&&(n.agent=y.value);const v=await(await fetch("/api/panes",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(n)})).json();v.needsAgentChoice?(j.value=!0,O.value=v.availableAgents,b.value="agent"):(q(),await f())}catch(n){console.error("Failed to create pane:",n),alert("Failed to create pane")}finally{I.value=!1}},oe=n=>{y.value=n,J()},f=async()=>{try{const l=await(await fetch("/api/panes")).json();z.value=l.projectName||"dmux",e.value=l.sessionName||"",M.value=!0,N.value=l.panes||[],t.value=new Date,u.value="Just now";for(const v of N.value)E.value[v.id]||R(v.id)}catch(n){console.error("Failed to fetch panes:",n),M.value=!1}},R=async n=>{try{const v=await(await fetch(\`/api/panes/\${n}/actions\`)).json();console.log(\`Fetched actions for pane \${n}:\`,v),E.value[n]=v.actions||[]}catch(l){console.error(\`Failed to fetch actions for pane \${n}:\`,l)}},ne=n=>{k.value===n?k.value=null:k.value=n},ae=async(n,l)=>{try{U.value=!0,k.value=null;const Q=await(await fetch(\`/api/panes/\${n.id}/actions/\${l.id}\`,{method:"POST"})).json();Q.requiresInteraction?(p.value=Q.interactionData,p.value.paneId=n.id):await f()}catch(v){console.error("Failed to execute action:",v),alert("Failed to execute action")}finally{U.value=!1}},V=()=>{p.value=null},se=async n=>{if(p.value)try{const l=await fetch(\`/api/callbacks/confirm/\${p.value.callbackId}\`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({confirmed:n})});await f(),V()}catch(l){console.error("Failed to confirm action:",l),alert("Failed to complete action")}},ie=async n=>{if(p.value)try{const l=await fetch(\`/api/callbacks/choice/\${p.value.callbackId}\`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({optionId:n})});await f(),V()}catch(l){console.error("Failed to select choice:",l),alert("Failed to complete action")}},le=async(n,l)=>{try{m.value.add(n.id),m.value=new Set(m.value),await fetch(\`/api/keys/\${n.paneId}\`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({keys:l.action})}),setTimeout(()=>{m.value.delete(n.id),m.value=new Set(m.value),f()},1500)}catch(v){console.error("Failed to select option:",v),m.value.delete(n.id),m.value=new Set(m.value)}},ce=async n=>{const l=S.value[n.id];if(!(!l||!l.trim()))try{g.value.add(n.id),g.value=new Set(g.value),await fetch(\`/api/keys/\${n.paneId}\`,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({keys:l})}),T.value[n.id]=l.substring(0,50)+(l.length>50?"...":""),S.value[n.id]="",setTimeout(()=>{delete T.value[n.id],g.value.delete(n.id),g.value=new Set(g.value)},3e3)}catch(v){console.error("Failed to send prompt:",v),g.value.delete(n.id),g.value=new Set(g.value)}},re=n=>{const l=n.target;l.style.height="auto",l.style.height=l.scrollHeight+"px"},B=()=>{f(),C=setInterval(f,2e3)},H=()=>{C&&(clearInterval(C),C=null)},L=n=>{const l=n.target;k.value&&!l.closest(".action-menu-btn")&&!l.closest(".action-menu-dropdown")&&(k.value=null)};ue(()=>{document.documentElement.setAttribute("data-theme",_.value),B(),document.addEventListener("click",L),document.addEventListener("visibilitychange",()=>{document.hidden?H():B()})}),ve(()=>{H(),document.removeEventListener("click",L)});const K={projectName:z,sessionName:e,connected:M,panes:N,lastUpdate:t,timeSinceUpdate:u,promptInputs:S,sendingPrompts:g,queuedMessages:T,theme:_,expandedPrompts:w,loadingOptions:m,showCreateDialog:F,newPanePrompt:P,newPaneAgent:y,creatingPane:I,availableAgents:O,needsAgentChoice:j,createStep:b,actions:Y,paneActions:E,showActionMenu:k,actionDialog:p,executingAction:U,get refreshInterval(){return C},set refreshInterval(n){C=n},toggleTheme:$,togglePrompt:ee,openCreateDialog:te,closeCreateDialog:q,createPane:J,selectAgent:oe,fetchPanes:f,fetchPaneActions:R,toggleActionMenu:ne,executeAction:ae,closeActionDialog:V,confirmAction:se,selectChoice:ie,selectOption:le,sendPrompt:ce,autoExpand:re,startAutoRefresh:B,stopAutoRefresh:H,handleClickOutside:L};return Object.defineProperty(K,"__isScriptSetup",{enumerable:!1,value:!0}),K}}),ye={class:"session-info"},ke=["title"],_e={key:0,xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},we={key:1,xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24"},be={key:0},Ce={class:"container"},Se={class:"actions-bar"},Pe=["disabled"],xe={key:0,class:"no-panes"},Ae={key:1,class:"panes-grid"},De={class:"pane-header"},Me={class:"pane-header-content"},Ne=["href"],Oe={class:"pane-title"},je={class:"pane-meta"},ze={class:"pane-id"},Te=["onClick"],Fe={key:0,class:"action-menu-dropdown"},Ie=["onClick","disabled"],Ee={class:"action-icon"},Ue={class:"action-label"},Ve={class:"pane-prompt-section"},Be=["onClick"],He={class:"expand-icon"},Le={key:0,class:"pane-prompt"},qe={key:1,class:"agent-summary"},Je={key:0,class:"options-dialog"},Re={class:"options-question"},Ke={key:0,class:"options-warning"},Qe={key:1,class:"analyzing-state"},We={key:2,class:"options-buttons"},Ze=["onClick","disabled"],Ge={class:"prompt-input-wrapper"},Xe=["onUpdate:modelValue","placeholder","disabled"],Ye=["onClick","disabled","title"],$e={key:0,class:"button-loader"},et={key:1,xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 988.44 1200.05"},tt={key:0,class:"queued-message"},ot={key:2,class:"dev-server-status"},nt=["href"],at={class:"action-dialog"},st={key:0},it=["onKeydown"],lt={class:"dialog-buttons"},ct=["disabled"],rt={key:1},dt={class:"agent-choices"},ut=["onClick","disabled"],vt={key:0,class:"action-dialog"},gt={class:"dialog-buttons"},mt={class:"action-dialog"},ht={key:0},pt={class:"choice-options"},ft=["onClick"],yt={class:"choice-label"},kt={key:0,class:"choice-description"};function _t(X,a,z,e,M,N){return i(),s(h,null,[o("header",null,[a[6]||(a[6]=o("img",{src:"https://cdn.formk.it/dmux/dmux.png",alt:"dmux",class:"logo"},null,-1)),o("h1",null,r(e.projectName),1),o("div",ye,[o("button",{onClick:e.toggleTheme,class:"theme-toggle",title:e.theme==="dark"?"Switch to light mode":"Switch to dark mode"},[e.theme==="dark"?(i(),s("svg",_e,[...a[4]||(a[4]=[o("path",{d:"M12 2.25a.75.75 0 01.75.75v2.25a.75.75 0 01-1.5 0V3a.75.75 0 01.75-.75zM7.5 12a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM18.894 6.166a.75.75 0 00-1.06-1.06l-1.591 1.59a.75.75 0 101.06 1.061l1.591-1.59zM21.75 12a.75.75 0 01-.75.75h-2.25a.75.75 0 010-1.5H21a.75.75 0 01.75.75zM17.834 18.894a.75.75 0 001.06-1.06l-1.59-1.591a.75.75 0 10-1.061 1.06l1.59 1.591zM12 18a.75.75 0 01.75.75V21a.75.75 0 01-1.5 0v-2.25A.75.75 0 0112 18zM7.758 17.303a.75.75 0 00-1.061-1.06l-1.591 1.59a.75.75 0 001.06 1.061l1.591-1.59zM6 12a.75.75 0 01-.75.75H3a.75.75 0 010-1.5h2.25A.75.75 0 016 12zM6.697 7.757a.75.75 0 001.06-1.06l-1.59-1.591a.75.75 0 00-1.061 1.06l1.59 1.591z"},null,-1)])])):(i(),s("svg",we,[...a[5]||(a[5]=[o("path",{d:"M9.528 1.718a.75.75 0 01.162.819A8.97 8.97 0 009 6.5a9 9 0 009 9 8.97 8.97 0 003.963-.69.75.75 0 01.981.98 10.503 10.503 0 01-9.694 6.46c-5.799 0-10.5-4.701-10.5-10.5 0-4.368 2.667-8.112 6.46-9.694a.75.75 0 01.818.162z"},null,-1)])]))],8,ke),e.sessionName?(i(),s("span",be,r(e.sessionName),1)):d("v-if",!0),o("span",{class:"status-indicator",style:me({color:e.connected?"#4ade80":"#f87171"})},"●",4)])]),o("div",Ce,[o("main",null,[o("div",Se,[o("button",{onClick:e.openCreateDialog,class:"create-pane-button",disabled:e.creatingPane},[...a[7]||(a[7]=[o("svg",{xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 24 24",fill:"currentColor"},[o("path",{d:"M12 4.5v15m7.5-7.5h-15",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round"})],-1),he(" Create New Pane ",-1)])],8,Pe)]),e.panes.length===0?(i(),s("div",xe,[...a[8]||(a[8]=[o("p",null,"No dmux panes active",-1),o("p",{class:"hint"},\`Click "Create New Pane" above or press 'n' in dmux\`,-1)])])):(i(),s("div",Ae,[(i(!0),s(h,null,x(e.panes,t=>(i(),s("div",{key:t.id,class:"pane-card"},[o("div",De,[o("div",Me,[o("a",{href:"/panes/"+t.id,class:"pane-title-link"},[o("span",Oe,r(t.slug),1),a[9]||(a[9]=o("span",{class:"pane-arrow"},"→",-1))],8,Ne),o("div",je,[o("span",{class:D(["pane-agent",t.agent||""])},r(t.agent||"unknown"),3),o("span",ze,r(t.paneId),1)])]),o("button",{onClick:u=>e.toggleActionMenu(t.id),class:"action-menu-btn",title:"Actions"},[...a[10]||(a[10]=[o("span",null,"⋮",-1)])],8,Te)]),d(" Action Menu Dropdown "),e.showActionMenu===t.id&&e.paneActions[t.id]?(i(),s("div",Fe,[(i(!0),s(h,null,x(e.paneActions[t.id],u=>(i(),s("button",{key:u.id,onClick:S=>e.executeAction(t,u),class:"action-menu-item",disabled:e.executingAction},[o("span",Ee,r(u.icon||"•"),1),o("span",Ue,r(u.label),1)],8,Ie))),128))])):d("v-if",!0),o("div",Ve,[o("div",{class:D(["pane-prompt-header",{expanded:e.expandedPrompts.has(t.id)}]),onClick:u=>e.togglePrompt(t.id)},[a[11]||(a[11]=o("span",{class:"prompt-label"},"Initial Prompt",-1)),o("span",He,r(e.expandedPrompts.has(t.id)?"▼":"▶"),1)],10,Be),e.expandedPrompts.has(t.id)?(i(),s("div",Le,r(t.prompt||"No prompt"),1)):d("v-if",!0)]),d(" Show agent summary when idle "),t.agentStatus==="idle"&&t.agentSummary?(i(),s("div",qe,r(t.agentSummary),1)):d("v-if",!0),o("div",{class:"pane-interactive",onClick:a[0]||(a[0]=A(()=>{},["prevent"]))},[d(" Options Dialog (when waiting with options) "),t.agentStatus==="waiting"&&t.options&&t.options.length>0?(i(),s("div",Je,[o("div",Re,r(t.optionsQuestion||"Choose an option:"),1),t.potentialHarm&&t.potentialHarm.hasRisk?(i(),s("div",Ke," ⚠️ "+r(t.potentialHarm.description),1)):d("v-if",!0),e.loadingOptions.has(t.id)?(i(),s("div",Qe,[...a[12]||(a[12]=[o("div",{class:"loader-spinner"},null,-1),o("span",null,"Processing selection...",-1)])])):(i(),s("div",We,[(i(!0),s(h,null,x(t.options,u=>(i(),s("button",{key:u.action,onClick:S=>e.selectOption(t,u),class:D(["option-button",{"option-button-danger":t.potentialHarm&&t.potentialHarm.hasRisk}]),disabled:e.loadingOptions.has(t.id)},r(u.action),11,Ze))),128))]))])):t.agentStatus==="analyzing"?(i(),s(h,{key:1},[d(" Analyzing (show loader) "),a[13]||(a[13]=o("div",{class:"analyzing-state"},[o("div",{class:"loader-spinner"}),o("span",null,"Analyzing...")],-1))],2112)):(i(),s(h,{key:2},[d(" Working/Idle (show prompt input) "),o("div",null,[o("div",Ge,[W(o("textarea",{"onUpdate:modelValue":u=>e.promptInputs[t.id]=u,onInput:e.autoExpand,placeholder:t.agentStatus==="working"?"Queue a prompt...":"Send a prompt...",disabled:e.sendingPrompts.has(t.id),class:"prompt-textarea",rows:"1"},null,40,Xe),[[Z,e.promptInputs[t.id]]]),o("button",{onClick:u=>e.sendPrompt(t),disabled:!e.promptInputs[t.id]||e.sendingPrompts.has(t.id),class:"send-button",title:t.agentStatus==="working"?"Queue prompt":"Send prompt"},[e.sendingPrompts.has(t.id)?(i(),s("span",$e)):(i(),s("svg",et,[...a[14]||(a[14]=[o("path",{d:"M425.13,28.37L30.09,423.41C11.19,441.37.34,466.2,0,492.27c-.34,26.07,9.86,51.17,28.29,69.61,18.43,18.45,43.52,28.67,69.59,28.35,26.07-.31,50.91-11.14,68.88-30.02l233.16-233.52v776.64c0,34.56,18.43,66.48,48.36,83.76,29.93,17.28,66.8,17.28,96.72,0,29.93-17.28,48.36-49.21,48.36-83.76V328.85l231.72,231.36c24.63,23.41,59.74,32.18,92.48,23.09,32.74-9.08,58.32-34.68,67.38-67.43,9.05-32.75.25-67.85-23.18-92.46L566.73,28.37C548.63,10.16,524-.04,498.33.05c-.8-.06-1.6-.06-2.4,0-.8-.06-1.6-.06-2.4,0-25.65,0-50.25,10.19-68.4,28.32h0Z"},null,-1)])]))],8,Ye)]),e.queuedMessages[t.id]?(i(),s("div",tt," ✓ "+r(e.queuedMessages[t.id]),1)):d("v-if",!0)])],2112))]),t.devStatus&&t.devStatus!=="stopped"?(i(),s("div",ot,[a[15]||(a[15]=o("span",{class:"status-label"},"Dev Server:",-1)),o("span",{class:D(["status-badge",t.devStatus])},r(t.devStatus),3),t.devUrl?(i(),s("a",{key:0,href:t.devUrl,target:"_blank",class:"dev-link"},"↗",8,nt)):d("v-if",!0)])):d("v-if",!0)]))),128))]))]),d(" Create Pane Dialog "),e.showCreateDialog?(i(),s("div",{key:0,class:"action-dialog-overlay",onClick:A(e.closeCreateDialog,["self"])},[o("div",at,[a[18]||(a[18]=o("h3",null,"Create New Pane",-1)),e.createStep==="prompt"?(i(),s("div",st,[a[16]||(a[16]=o("label",{for:"pane-prompt"},"What would you like to work on?",-1)),W(o("textarea",{id:"pane-prompt","onUpdate:modelValue":a[1]||(a[1]=t=>e.newPanePrompt=t),placeholder:"E.g., Fix the authentication bug, Add dark mode, etc.",rows:"4",onKeydown:[G(A(e.createPane,["meta"]),["enter"]),G(A(e.createPane,["ctrl"]),["enter"])]},null,40,it),[[Z,e.newPanePrompt]]),o("div",lt,[o("button",{onClick:e.closeCreateDialog,class:"dialog-btn"},"Cancel"),o("button",{onClick:e.createPane,disabled:!e.newPanePrompt.trim()||e.creatingPane,class:"dialog-btn dialog-btn-primary"},r(e.creatingPane?"Creating...":"Create Pane"),9,ct)])])):e.createStep==="agent"?(i(),s("div",rt,[a[17]||(a[17]=o("p",null,"Multiple agents available. Choose one:",-1)),o("div",dt,[(i(!0),s(h,null,x(e.availableAgents,t=>(i(),s("button",{key:t,onClick:u=>e.selectAgent(t),class:"agent-choice-button",disabled:e.creatingPane},r(t),9,ut))),128))]),o("div",{class:"dialog-buttons"},[o("button",{onClick:e.closeCreateDialog,class:"dialog-btn"},"Cancel")])])):d("v-if",!0)])])):d("v-if",!0),d(" Action Dialogs "),e.actionDialog?(i(),s("div",{key:1,class:"action-dialog-overlay",onClick:A(e.closeActionDialog,["self"])},[d(" Confirm Dialog "),e.actionDialog.type==="confirm"?(i(),s("div",vt,[o("h3",null,r(e.actionDialog.title),1),o("p",null,r(e.actionDialog.message),1),o("div",gt,[o("button",{onClick:a[2]||(a[2]=t=>e.confirmAction(!1)),class:"dialog-btn"},"Cancel"),o("button",{onClick:a[3]||(a[3]=t=>e.confirmAction(!0)),class:"dialog-btn dialog-btn-primary"},"Confirm")])])):e.actionDialog.type==="choice"?(i(),s(h,{key:1},[d(" Choice Dialog "),o("div",mt,[o("h3",null,r(e.actionDialog.title),1),e.actionDialog.message?(i(),s("p",ht,r(e.actionDialog.message),1)):d("v-if",!0),o("div",pt,[(i(!0),s(h,null,x(e.actionDialog.options,t=>(i(),s("button",{key:t.id,onClick:u=>e.selectChoice(t.id),class:D(["choice-option-btn",{danger:t.danger}])},[o("div",yt,r(t.label),1),t.description?(i(),s("div",kt,r(t.description),1)):d("v-if",!0)],10,ft))),128))]),o("div",{class:"dialog-buttons"},[o("button",{onClick:e.closeActionDialog,class:"dialog-btn"},"Cancel")])])],2112)):d("v-if",!0)])):d("v-if",!0)])],64)}const wt=ge(fe,[["render",_t],["__file","/Users/justinschroeder/Projects/dmux/.dmux/worktrees/create-new-pane-styling/frontend/src/components/Dashboard.vue"]]),bt=pe(wt);bt.mount("#app");
`,
    mimeType: 'application/javascript',
    size: 15330
>>>>>>> create-new-pane-styling
  },
  'index.js': {
