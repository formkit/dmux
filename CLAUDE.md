...
- **AI Features**: Uses locally-installed agents (`claude --print`, `opencode run`) via unified agent harness; optional OpenRouter API for slug generation
...
- Optional: GitHub CLI (`gh`) for PR workflow, `OPENROUTER_API_KEY` for AI slug generation
